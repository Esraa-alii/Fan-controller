 ...
 * Argument    : command -> the command to be sent
 * Return      : None
 */
 ...
 * Argument    : data -> data to be displayed
 * Return      : None
 */
 ...
 * Argument    : pointer to string to be displayed
 * Return      : None
 */
 ...
 * Arguments   : row -> number of row which the cursor will be moved to
 *               col -> number of column which the cursor will be moved to
 * Return      : None
 */
 ...
 * Argument    : data -> display decimal numbers
 * Return      : None
 */
